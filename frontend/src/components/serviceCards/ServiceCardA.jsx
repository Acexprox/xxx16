      ...
      <div className="relative z-10 grid grid-cols-[1fr_1.05fr] gap-0 px-6 mt-4" dir="rtl">
        ...
        >
          ...
          >
            ...
            <div className="text-[12px] mt-0.5 leading-relaxed font-semibold" style={{ color: "#6B4E2E" }}>نوفر فئات متعددة من البطائق الالكترونية مسبقة الدفع تشمل بطائق مالية وبطائق العاب وبطائق تسوق متاجر الكترونية</div>
          </div>
        ...
        >
          ...
          <div className="relative z-10 h-full flex flex-col justify-between p-4 pb-48">
